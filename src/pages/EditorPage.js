...
const EditorPage = () => {
    ...
    const init = async () => {
      ...
      socketRef.current.on(
        ...
        ({ clients, username, socketId }) => {
          if (username !== location.state?.username) {
            ...
            console.log(
              `${username} joined the roomId : ${roomId}`
            );
          }
          setClients(clients);
      ...
      socketRef.current.on(
        ...
        ({ username, socketId }) => {
          ...
          console.log(
            `${username} left the roomId : ${roomId}`
          );
          setClients((prev) => {
            return prev.filter(
  ...
  const onLanguageChange = (e) => {
    try {
      ...
      toast.error("Could not change the Language");
    }
  };
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setTimeout(
                () =>
                  toast(
                    `You changed the language to ${e.target.value}`,
                    {
                      icon: "🤖",
                    }
                  ),
        ...
        <label>
          ...
          <select
            ...
            onChange={(e) => {
              onThemeChange(e);
              toast(
                `You changed the theme to ${e.target.value}`,
                {
                  icon: "🌈",
                }
              );
          ...
          >
            ...
            <option value="duotone-dark">
              duotone-dark
            </option>
            <option value="duotone-light">
              duotone-light
            </option>
            ...
            <option value="oceanic-next">
              oceanic-next
            </option>
            <option value="panda-syntax">
              panda-syntax
            </option>
